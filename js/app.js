    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                if (bodyLockStatus && targetElement.closest(".icon-menu")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
                if (bodyLockStatus && !targetElement.closest(".menu__body")) functions_menuClose();
            }));
        ...
        function formFieldsInit(options = {
            ...
            if (options.viewPass) document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest('[class*="__viewpass"]')) {
                    let viewpassButton = targetElement.closest('[class*="__viewpass"]');
                    let inputElement = viewpassButton.parentElement.querySelector("input");
                    if (inputElement) {
                    ...
                    } else console.error("Input element not found with in the parent element.");
                }
            }));
        ...
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+38 (999) 999-99-99", {
...
***************************************************************************** */        var __assign = function() {
        ...
        function initSliders() {
            if (document.querySelector(".hero__body")) new Swiper(".hero__body", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".controls-hero__btn_prev",
                    nextEl: ".controls-hero__btn_next"
                },
                on: {}
            });
            if (document.querySelector(".products-carousel__body")) new Swiper(".products-carousel__body", {
                ...
                speed: 500,
                pagination: {
                    el: ".products-carousel__pagination"
                },
                navigation: {
                    prevEl: ".products-carousel__btn_prev",
                    nextEl: ".products-carousel__btn_next"
                },
                breakpoints: {
                    440: {
                        slidesPerView: 1.5,
            ...
            if (document.querySelector(".collections__inner")) new Swiper(".collections__inner", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.05,
                ...
                speed: 500,
                navigation: {
                    prevEl: ".collections__arrow_prev",
                    nextEl: ".collections__arrow_next"
                },
                breakpoints: {
                    440: {
                        slidesPerView: 1.3
            ...
            if (document.querySelector(".main-product__gallery")) {
                const thumbnails = new Swiper(".main-product__thumbnails", {
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    spaceBetween: 10,
                ...
                new Swiper(".main-product__gallery", {
                    ...
                    loop: true,
                    pagination: {
                        el: ".main-product__gallery-pagination"
                    },
                    navigation: {
                        prevEl: ".main-product__gallery-arrow_prev",
                        nextEl: ".main-product__gallery-arrow_next"
                    },
                    thumbs: {
                        swiper: thumbnails
                    },
        ...
        window.onload = () => {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 991 && isMobile.any()) {
                    const openItems = document.querySelectorAll(".menu__item_more._hover");
                    if (targetElement.closest(".menu__item_more")) {
                        openItems.forEach((item => {
                            if (item !== targetElement.closest(".menu__item_more")) item.classList.remove("_hover");
                        }));
                        targetElement.closest(".menu__item_more").classList.toggle("_hover");
                    } else removeClasses(openItems, "_hover");
                }
                if (isMobile.any()) {
                    if (targetElement.closest(".filter__sort-head")) targetElement.closest(".filter__sort-select").classList.toggle("_hover");
                    if (!targetElement.closest(".filter__sort-select") && document.querySelector(".filter__sort-select._hover")) document.querySelector(".filter__sort-select").classList.remove("_hover");
                }
                if (isMobile.any()) {
                    if (targetElement.closest(".actions-header__currency-head")) targetElement.closest(".actions-header__currency").classList.toggle("_hover");
                    if (!targetElement.closest(".actions-header__currency") && document.querySelector(".actions-header__currency._hover")) document.querySelector(".actions-header__currency").classList.remove("_hover");
                }
                if (window.innerWidth < 991 && isMobile.any()) {
                    if (targetElement.closest(".fixed-summary")) {
                        document.querySelector(".summary-checkout").classList.add("_open");
                        bodyLock();
                    }
                    if (targetElement.closest(".summary__hide")) {
                        document.querySelector(".summary-checkout").classList.remove("_open");
                        bodyUnlock();
                    }
                }
            }
        ...
        function filter() {
            if (document.querySelector(".filter")) document.addEventListener("click", (function(e) {
                const targetElement = e.target;
                if (targetElement.closest(".categories__filter-button")) {
                ...
                if (bodyLockStatus && !targetElement.closest(".filter")) document.documentElement.classList.remove("filter-open");
            }));
        }
        filter();
        const sortSelect = document.querySelector(".filter__sort-select");
        if (sortSelect) {
            const sortSelectHead = document.querySelector(".filter__sort-head span");
            const sortSelectItem = document.querySelectorAll(".filter__sort-item");
            sortSelectItem.forEach((item => {
                item.addEventListener("click", (() => {
                    sortSelectHead.textContent = item.textContent;
                    document.querySelector(".filter__sort-select").classList.remove("_hover");
                }));
            }));
        }
        const currencySelect = document.querySelector(".actions-header__currency");
        if (currencySelect) {
            const currencySelectHead = document.querySelector(".actions-header__currency-head span");
            const currencySelectItem = document.querySelectorAll(".actions-header__currency-item");
            currencySelectItem.forEach((item => {
                item.addEventListener("click", (() => {
                    currencySelectHead.textContent = item.textContent;
                    document.querySelector(".actions-header__currency").classList.remove("_hover");
                }));
            }));
        }
        ...
        const accordions = document.querySelectorAll("[data-accardion]");
        for (let i = 0; i < accordions.length; i++) {
            const accordion = accordions[i];
            const title = accordion.querySelector("[data-accardion-title]");
            const content = accordion.querySelector("[data-accardion-content]");
            title.addEventListener("click", (function(e) {
                const isActive = accordion.classList.contains("_accordion-active");
                if (e.target.closest(".radio__input")) return;
                for (let j = 0; j < accordions.length; j++) {
                    const otherAccordion = accordions[j];
                    if (otherAccordion !== accordion) {
                        otherAccordion.classList.remove("_accordion-active");
                        _slideUp(otherAccordion.querySelector("[data-accardion-content]"));
                    }
                }
                if (isActive) {
                    accordion.classList.remove("_accordion-active");
                    _slideUp(content);
                } else {
                    accordion.classList.add("_accordion-active");
                    _slideDown(content);
                }
            }));
            if (accordion.classList.contains("_accordion-active")) _slideDown(content); else _slideUp(content);
        }
        function initUserNavSelect() {
            const userNav = document.querySelector(".user-nav");
            if (!userNav) return;
            if (window.innerWidth < 991) {
                document.addEventListener("click", handleUserNavClick);
                const userNavList = document.querySelector(".user-nav__list");
                const userNavSelected = document.querySelector(".user-nav__selected > span");
                _slideUp(userNavList, 0);
                function handleUserNavClick(e) {
                    const targetElement = e.target;
                    if (targetElement.closest(".user-nav__selected")) {
                        console.log("Toggling list");
                        _slideToggle(userNavList, 300);
                        userNav.classList.toggle("_active");
                        return;
                    }
                    if (targetElement.closest(".user-nav__link")) {
                        userNavSelected.textContent = targetElement.textContent;
                        _slideUp(userNavList, 300);
                        userNav.classList.remove("_active");
                        return;
                    }
        ...
        if (document.querySelector(".btn-top")) document.querySelector(".btn-top").addEventListener("click", scrollToTop);
        window["FLS"] = false;
        isWebp();
        menuInit();
        spollers();
